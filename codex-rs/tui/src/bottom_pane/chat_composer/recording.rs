//! Recording-meter placeholder helpers for [`ChatComposer`].
//!
//! These mirror the named-element placeholder lifecycle used while an audio
//! recording meter is shown inline in the composer. They are only compiled on
//! non-Linux targets, matching the `next_id` helper they depend on.
