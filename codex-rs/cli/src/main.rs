...
mod desktop_app;
mod doctor;
mod exec_server_cmd; // fork-local: exec server subcommand module
mod exec_server_telemetry;
mod features_cmd; // fork-local: feature flags subcommand module
mod interactive_cmd; // fork-local: interactive session subcommand module
mod marketplace_cmd;
mod mcp_cmd;
mod plugin_cmd;
...
fn resolve_profile_v2_config_path(
    ...
    AbsolutePathBuf::resolve_path_against_base(format!("{profile_name}.config.toml"), codex_home)
}
