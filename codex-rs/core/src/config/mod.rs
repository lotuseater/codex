...
pub use fork_config::ActionOptimizationInstructionsConfig;
pub use fork_config::ActionOptimizationInstructionsMode;
pub use fork_config::ActionOptimizationInstructionsVariant;
pub use fork_config::BatchMiniProgrammingInstructionsConfig;
pub use fork_config::BatchMiniProgrammingInstructionsMode;
pub use fork_config::BatchMiniProgrammingInstructionsVariant;
pub use fork_config::CodeModeConfig;
pub use fork_config::AutoCoordinatorMode;
pub use fork_config::CurrentTimeReminderConfig;
pub use fork_config::DesktopAutomationConfig;
pub use fork_config::GhostSnapshotConfig;
pub use fork_config::MultiAgentV2Config;
pub use fork_config::RolloutBudgetConfig;
pub use fork_config::StreamResilienceConfig;
pub use fork_config::TerminalResizeReflowConfig;
pub use fork_config::TerminalResizeReflowMaxRows;
pub use fork_config::UsageHintCadence;
use fork_config::DelegationInjectionRole;
...
impl Config {
    ...
    pub fn http_client_factory(&self) -> HttpClientFactory {
        // fork-local: fork `Config` has no `respect_system_proxy` field; derive it from the feature flag.
        let outbound_proxy_policy = if self.features.enabled(Feature::RespectSystemProxy) {
...
impl Config {
    ...
    pub fn bundled_skills_enabled(&self) -> bool {
        codex_core_skills::service::bundled_skills_enabled_from_stack(&self.config_layer_stack)
    }
}
...
pub struct Config {
    ...
    /// Thread-scoped runtime workspace roots resolved at config load. Symbolic
    /// `:project_roots` permission entries are materialized against these roots
    /// (plus any profile-declared roots) when computing effective permissions.
    ...
    /// Repo-local blackboard coordination settings.
