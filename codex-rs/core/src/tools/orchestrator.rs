...
impl ToolOrchestrator {
        ...
        T: ToolRuntime<Rq, Out>,
    {
        ...
        let initial_exec_server_permissions = turn_ctx.config.permissions.permission_profile();
        let initial_attempt = SandboxAttempt {
            sandbox: initial_sandbox,
            sandbox_requested,
            permissions: &turn_ctx.permission_profile,
            exec_server_permissions: &initial_exec_server_permissions,
        ...
        match first_result {
            ...
            Err(ToolError::Codex(CodexErr::Sandbox(SandboxErr::Denied {
                ...
                let retry_exec_server_permissions =
                    turn_ctx.config.permissions.permission_profile();
                let retry_attempt = SandboxAttempt {
                    sandbox: retry_sandbox,
                    sandbox_requested: retry_sandbox_requested,
                    permissions: &turn_ctx.permission_profile,
                    exec_server_permissions: &retry_exec_server_permissions,
                    enforce_managed_network: managed_network_active,
                    manager: &self.sandbox,
                    sandbox_cwd: &sandbox_policy_cwd,
                    workspace_roots: workspace_roots.as_slice(),
