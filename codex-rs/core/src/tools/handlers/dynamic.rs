...
impl DynamicToolHandler {
    ...
    fn from_parts(
        ...
        Some(Self {
            ...
            search_text: build_dynamic_search_text(tool, namespace.map(|ns| ns.name.as_str())),
        })
    }
}
...
fn build_dynamic_search_text(tool: &DynamicToolFunctionSpec, namespace: Option<&str>) -> String {
