...
struct ReplacementBenchRecord {
    ...
    intent: &'static str,
    useful_when: &'static str,
    not_for: &'static str,
    direct_replacement_safe: bool,
    replacement_policy: &'static str,
    unsafe_to_replace_reason: &'static str,
...
async fn run_shell_shadow(
    ...
    let record = ReplacementBenchRecord {
        ...
        not_for: candidate.not_for(),
        direct_replacement_safe: candidate.direct_replacement_safe(),
        replacement_policy: candidate.replacement_policy(),
        unsafe_to_replace_reason: candidate.unsafe_to_replace_reason(),
