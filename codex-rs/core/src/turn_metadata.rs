...
pub(crate) struct TurnMetadataState {
    ...
    // fork-local: git-head tracking for compaction (used by ensure_initial_git_commit_hash
    // and git_head_changed_since_start, which survived upstream's responses_metadata rework).
...
impl TurnMetadataState {
    ...
    pub(crate) fn new(
        ...
        Self {
            ...
            // fork-local: see struct field comment.
