...
pub fn new_prompt_reduction_event(message: String) -> PrefixedWrappedHistoryCell {
    PrefixedWrappedHistoryCell::new(message.cyan(), "🌈 ".magenta(), "  ")
}

#[derive(Debug)]
pub struct SafetyAccessBlockCell {
    body: &'static str,
...
pub fn new_safety_access_block_event() -> SafetyAccessBlockCell {
...
pub fn new_cyber_policy_error_event() -> SafetyAccessBlockCell {
    SafetyAccessBlockCell {
