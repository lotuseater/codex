...
pub fn new_session_info(
    ...
    if is_first_event {
        ...
        if show_tooltips
            && let Some(tooltips) = tooltip_override.map(|tip| TooltipHistoryCell::new(tip, cwd))
        {
...
pub fn has_yolo_permissions(
    ...
    match permission_profile {
        ...
        PermissionProfile::Managed { .. } | PermissionProfile::External { .. } => false,
    }
}
#[derive(Debug)]
pub struct SessionHeaderHistoryCell {
    version: &'static str,
    model: String,
    model_style: Style,
...
impl SessionHeaderHistoryCell {
    ...
    pub fn format_directory_inner(directory: &Path, max_width: Option<usize>) -> String {
