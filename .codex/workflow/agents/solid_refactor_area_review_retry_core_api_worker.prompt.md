# solid_refactor_area_review_retry_core_api_worker
...
Review scope:
- `codex-core-api` identifier/domain-type boundary changes and consumer fallout.
- Check whether source imports, lockfile/manifest changes, schema/Bazel follow-up classification, and re-export boundaries are coherent.
...
Write `.codex/workflow/agents/solid_refactor_area_review_retry_core_api_worker.handoff.md` with findings first, file:line evidence, and exact root-owned next action.
