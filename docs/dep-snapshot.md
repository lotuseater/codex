...
Generated: 2026-05-10T22:51:19+03:00 (regenerate via `scripts/dep-snapshot.ps1`).

## Lockfile census

- Total locked entries: **1296**
- Cross-version duplicate families: **48** (sum 100 version entries)
...
## Cross-version duplicate families
